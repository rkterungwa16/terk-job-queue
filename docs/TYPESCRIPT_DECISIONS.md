...
| `useId` | `SearchBar.tsx` | Correct `<label htmlFor>`/`<input id>` association for accessibility without a hardcoded id string that could collide if the component were ever rendered more than once. |
